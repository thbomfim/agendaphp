...
class Contato
{
    ...
    {
        //verifica se os inputs foram digitados
        switch (true) {
            case empty($this->nome):
                echo 'Digite um nome';
                return;
            case empty($this->celular):
                echo 'Digite um celular';
                return;
            case empty($this->email):
                echo 'Digite um email';
                return;
            default: 
                echo 'alguns dos dados foram digitados errados';
                return;
        }
...
?>
            ...
            <a href="agenda.php?pg=deletarContato&id=<?= $valor['id'] ?>" onclick="return confirm('Tem certeza que deseja excluir estes dados?')">[X]</a> |
            <a href="agenda.php?pg=alterarContato&id=<?= $valor['id'] ?>">[A]</a>
            <hr>
<?php
        }
    }
